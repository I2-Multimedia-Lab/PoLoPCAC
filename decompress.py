...
parser.add_argument('decompressed_path', help='Decompressed file saving directory.')
...
print('Memory:', torch.cuda.max_memory_allocated(device=None)/1024/1024, 'MB')
print('ave dec time:', np.array(dec_times).mean())
